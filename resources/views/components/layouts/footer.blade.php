<footer aria-labelledby="footer-heading" class="bg-white">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16 md:mt-16 xl:mt-0">
                ...
                <form class="mt-2 flex sm:max-w-md">
                    ...
                    <input id="email-address" type="text" autocomplete="email" required
                        class="w-full min-w-0 appearance-none rounded-md border border-gray-300 bg-white py-2 px-4 text-base text-indigo-500 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
        ...
        <div class="border-t border-gray-200 py-10">
            <p class="text-sm text-gray-500">Copyright &copy; 2023 AM2 Development, Inc.</p>
        </div>
    </div>
</footer>