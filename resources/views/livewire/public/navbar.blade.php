<div class="bg-white dark:bg-gray-800">
                    ...
                    <div id="tabs-1-panel-1" class="px-4 pt-10 pb-8 space-y-10" aria-labelledby="tabs-1-tab-1"
                        ...
                        <div>
                            ...
                            <ul role="list" aria-labelledby="women-brands-heading-mobile"
                                ...
                                <li class="flow-root">
                                    <a href="#" class="block p-2 -m-2 text-gray-500 dark:text-gray-100">Significant
                                        Other</a>
                                </li>
                            </ul>
                        </div>
    ...
    <header class="relative bg-white dark:bg-gray-800">
        <p
            ...
            Frete grátis para pedidos acima de R$100</p>
                ...
                <div class="flex items-center h-16">
                    ...
                    <div class="flex ml-4 lg:ml-0">
                        <a href="#">
                            ...
                            <img class="w-auto h-8" src="https://tailwindui.com/img/logos/mark.svg?color=gray&shade=400"
                                alt="">
                        </a>
                    </div>
                    ...
                    <div class="flex items-center ml-auto">
                        <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                            <a href="#"
                                class="text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-gray-800 dark:hover:text-gray-400">Acessar</a>
                            <span class="w-px h-6 bg-gray-200" aria-hidden="true"></span>
                            <a href="#"
                                class="text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-gray-800 dark:hover:text-gray-400">Registrar-se</a>
                        </div>
                        ...
                        <div class="flow-root ml-4 lg:ml-6">
                            <a href="#" @click="$dispatch('open-modal', {id: 'cart'})"
                                ...
                                <span
                                    class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-200 group-hover:text-gray-800 dark:hover:text-gray-400 dark:group-hover:text-gray-100">2</span>
